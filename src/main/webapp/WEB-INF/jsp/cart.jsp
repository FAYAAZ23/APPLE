			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="panel-title">
						<div class="row">
							<div class="col-xs-3">
								<hr><h5><span class="glyphicon glyphicon-shopping-ViewCart"></span>View Cart</h5>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="panel-footer">
					<div class="row text-center">
						<div class="col-xs-3">
							<a href="Welcomepage" class="btn btn-default btn-sm btn-block">Continue Shopping</a></div>
						<div class="col-xs-6">
